...
export import omath.pathfinding.navigation_mesh;
...
export namespace omath::pathfinding
{
    ...
    public:
                                                     ...
                                                     const NavigationMesh& nav_mesh) noexcept
        {
            ...
            const auto maybe_start_vertex = nav_mesh.get_closest_vertex(start);
            const auto maybe_end_vertex = nav_mesh.get_closest_vertex(end);
