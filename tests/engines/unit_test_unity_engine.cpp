...
TEST(unit_test_unity_engine, ProjectTargetMovedFromCamera)
{
    ...
    const auto cam = omath::unity_engine::Camera({0, 0, 0}, {}, {.m_width=1280.f, .m_height=720.f}, fov, 0.01f, 1000.f);
...
TEST(unit_test_unity_engine, CameraSetAndGetFov)
{
    ...
    auto cam = omath::unity_engine::Camera({0, 0, 0}, {}, {.m_width=1920.f, .m_height=1080.f}, fov, 0.01f, 1000.f);
...
{
    auto cam = omath::unity_engine::Camera({0, 0, 0}, {}, {.m_width=1920.f, .m_height=1080.f}, {}, 0.01f, 1000.f);
