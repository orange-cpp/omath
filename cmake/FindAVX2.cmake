...
if(MSVC)
    ...
    set(_AVX2_CANDIDATES "-mfma -mavx2" "-msimd128 -mavx2" "-mavx2"
                         "-march=core-avx2" " ")
endif()
...
find_package_handle_standard_args(
    AVX2
    REQUIRED_VARS AVX2_WORKING_FLAG REASON_FAILURE_MESSAGE
                  "Your CPU or compiler does not support AVX2 instruction sets."
)
...
if(AVX2_FOUND)
    ...
    set(AVX2_FLAGS
        "${AVX2_WORKING_FLAG}"
        CACHE STRING "Calculated AVX2 compiler flags")
